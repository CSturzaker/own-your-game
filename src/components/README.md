...
| Component        | Import                                     | Variants                                                                    | Demo                            | Spec(s)                                                                              |
| ---------------- | ------------------------------------------ | --------------------------------------------------------------------------- | ------------------------------- | ------------------------------------------------------------------------------------ |
| VoiceCounterCard | `~/components/home/VoiceCounterCard.astro` | full-width counter band (DEV-124) · default · loading (skeleton) · error    | `/demo/voice-counter`           | `tests/e2e/voice-counter-card.spec.ts`, home integration in `tests/e2e/home.spec.ts` |
| CampaignFilm     | `~/components/home/CampaignFilm.astro`     | 9:16 click-to-play montage poster · duration chip · StreamPlayer states     | `/` hero (no demo)              | `tests/e2e/home.spec.ts` (campaign film suite)                                       |
