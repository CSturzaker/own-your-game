...
export function buildPlayerStrings(t: BoundT["t"]): PlayerStrings {
	return {
		...
		chips: {
			...
			transcript: t("player.chips.transcript"),
			transcriptTitle: t("player.chips.transcriptTitle"),
			transcriptUnavailable: t("player.chips.transcriptUnavailable"),
			transcriptClose: t("player.chips.transcriptClose"),
			...
			shareImage: t("player.chips.shareImage"),
		},
